...
<div class="row g-4 mb-4">
    <div class="col-6 col-lg-3 fade-in-up" style="animation-delay: 0.1s">
        <div class="card h-100">
            <div class="card-body text-center">
                <div class="display-5 fw-bold text-primary mb-2"><?= $totalProyectos ?></div>
    ...
    <div class="col-6 col-lg-3 fade-in-up" style="animation-delay: 0.2s">
        <div class="card h-100">
            <div class="card-body text-center">
                <div class="display-5 fw-bold mb-2" style="color: var(--primary-blue);"><?= $proyectosActivos ?></div>
    ...
    <div class="col-6 col-lg-3 fade-in-up" style="animation-delay: 0.3s">
        <div class="card h-100">
            <div class="card-body text-center">
                <div class="display-5 fw-bold mb-2" style="color: var(--secondary-green);"><?= $proyectosCompletados ?></div>
