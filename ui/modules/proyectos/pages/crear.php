<?php
/**
 * AND PROJECTS APP - Crear Proyecto
 */

if (!hasPermission('proyectos', 'crear')) {
    setFlashMessage('error', 'No tiene permisos para crear proyectos');
    header('Location: ' . uiModuleUrl('proyectos'));
    exit;
}

$pageTitle = 'Nuevo Proyecto';
$pageSubtitle = 'Crear un nuevo proyecto';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            setFlashMessage('success', 'Proyecto creado correctamente');
            header('Location: ' . uiModuleUrl('proyectos'));
            exit;
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="mb-0"><i class="bi bi-folder-plus me-2"></i>Nuevo Proyecto</h6>
                <a href="<?= uiModuleUrl('proyectos') ?>" class="btn btn-sm btn-outline-secondary">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="<?= uiModuleUrl('proyectos') ?>" class="btn btn-outline-secondary">Cancelar</a>
